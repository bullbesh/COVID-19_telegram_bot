...
def msg_send(update: Updater, context: CallbackContext):
	...
	reply_markup = ReplyKeyboardMarkup(
		keyboard = [
				[KeyboardButton(text = button_options),
				KeyboardButton(text = button_vaccine)],
	...
	update.message.reply_text(
		text = 'Используй навигационные кнопки ниже!',
...
def main():
	...
	updater.dispatcher.add_handler(MessageHandler(filters = Filters.all, callback = msg_send))
